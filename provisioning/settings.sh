...
export OKD_MASTER_IP=172.27.0.144
export OKD_MASTER_HOSTNAME=oc-master.csa343cloud.internal

#OKD Worker Node 1 Configuration
export OKD_WORKER_NODE_1_IP=172.27.0.5
export OKD_WORKER_NODE_1_HOSTNAME=oc-worker.csa343cloud.internal
